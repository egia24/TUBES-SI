    ...
    <div class="sidebar-scroll">
        <nav>
            <ul class="nav">
                ...
                <li><a href="/Distributor" class="active"><i class="lnr lnr-users"></i> <span>Distributor</span></a></li>
            </ul>
        </nav>
    </div>
</div>
            ...
            <div class="row">
                ...
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title">DISTRIBUTOR</h3><br>
                        <button> <a href="/iDistributor" type="button" class="btn btn-success">Tambah Data</a></button>
                    </div>
                    <div class="panel-body">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th>{{$distributors->id_distributor}}</th>
                                    <th>{{$distributors->nama_distributor}}</th>
                                    <th>{{$distributors->telepon_distributor}}</th>
                                    <th>{{$distributors->email_distributor}}</th>
                                    <td>
                                        <a href="/editDistributor/{{ $distributors->id }}" class="btn btn-warning"
                                            data-mdc-auto-init="MDCRipple">
                                            Edit
                                        </a>
                                        <a href="/delDistributor/{{ $distributors->id }}" class="btn btn-danger"
                                            data-mdc-auto-init="MDCRipple">
                                            Delete
                                        </a>
                                    </td>
