    ...
    <div class="sidebar-scroll">
        <nav>
            <ul class="nav">
                ...
                <li><a href="/Jenis_transaksi" class="active"><i class="lnr lnr-pushpin"></i> <span>Jenis Transaksi</span></a></li>
            ...
            <div class="row">
                ...
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title">JENIS TRANSAKSI</h3><br>
                        <button> <a href="/iJenis_transaksi" type="button" class="btn btn-success">Tambah
                                Data</a></button>
                    </div>
                    <div class="panel-body">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                @foreach ($data as $jenis_transaksis)
                                <tr>
                                    <th>{{$jenis_transaksis->id_jenis_transaksi}}</th>
                                    <th>{{$jenis_transaksis->nama_transaksi}}</th>
                                    <td>
                                        <a href="/editJenis_transaksi/{{ $jenis_transaksis->id }}"
                                            class="btn btn-warning" data-mdc-auto-init="MDCRipple">
                                            Edit
                                        </a>
                                        <a href="/delJenis_transaksi/{{ $jenis_transaksis->id }}" class="btn btn-danger"
