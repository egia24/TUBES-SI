    ...
    <div class="sidebar-scroll">
        <nav>
            <ul class="nav">
                ...
                <li><a href="/Transaksi_poin" class="active"><i class="lnr lnr-database"></i> <span>Transaksi Poin</span></a></li>
            ...
            <div class="row">
                ...
                <div class="panel">
                    <div class="panel-heading">
                        ...
                        <button> <a href="/iTransaksi_poin" type="button" class="btn btn-success">Tambah Data</a></button>
                        @if (count($data) > 0)
                            <button> <a href="/exportTransaksi_poin/{{ $data[0]->id }}" class="btn btn-success">Download PDF</a></button>
                        @endif
                    </div>
                    <div class="panel-body">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th>{{$transaksi_poins->id_transaksi_poin}}</th>
                                    <th>{{$transaksi_poins->pelanggan->id_pelanggan}}</th>
                                    <th>{{$transaksi_poins->poin->id_poin}}</th>
                                    <th>{{$transaksi_poins->tanggal_transaksi_poin}}</th>
                                    <th>{{$transaksi_poins->jumlah_poin}}</th>
                                    <td>
                                        <a href="/editTransaksi_poin/{{ $transaksi_poins->id }}" class="btn btn-warning"
                                            data-mdc-auto-init="MDCRipple">
                                            Edit
                                        </a>
                                        <a href="/delTransaksi_poin/{{ $transaksi_poins->id }}" class="btn btn-danger"
                                            data-mdc-auto-init="MDCRipple">
                                            Delete
                                        </a>
                                    </td>
