    ...
    <div class="sidebar-scroll">
        <nav>
            <ul class="nav">
                ...
                <li><a href="/Poin" class="active"><i class="lnr lnr-database"></i> <span>Poin</span></a></li>
            ...
            <div class="row">
                ...
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title">POIN</h3><br>
                        <button> <a href="/iPoin" type="button" class="btn btn-success">Tambah Data</a></button>
                    </div>
                    <div class="panel-body">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                @foreach ($data as $poins)
                                <tr>
                                    <th>{{$poins->id_poin}}</th>
                                    <th>{{$poins->nama_poin}}</th>
                                    <th>{{$poins->nilai_poin}}</th>
                                    <td>
                                        <a href="/editPoin/{{ $poins->id }}" class="btn btn-warning"
                                            data-mdc-auto-init="MDCRipple">
                                            Edit
                                        </a>
                                        <a href="/delPoin/{{ $poins->id }}" class="btn btn-danger"
                                            data-mdc-auto-init="MDCRipple">
                                            Delete
                                        </a>
                                    </td>
